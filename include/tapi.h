...
typedef enum {
    ...
    MSG_DATA_ENABLED_CHANGE_IND = 200,
    ...
    MSG_SIM_STATE_CHANGE_IND = 250,
    MSG_SIM_UICC_APP_ENABLED_CHANGE_IND,
    MSG_SIM_ICCID_CHANGE_IND,
    MSG_SIM_INVALID_CHANGE_IND,

    // STK Indication Message
    MSG_STK_AGENT_DISPLAY_TEXT_IND = 300,
...
typedef enum {
    TAPI_SERVICE_NONE = 0x0,
    TAPI_SERVICE_MODEM = 0x1,
    TAPI_SERVICE_RADIO = 0x2,
    TAPI_SERVICE_CALL = 0x4,
    TAPI_SERVICE_SIM = 0x8,
    TAPI_SERVICE_STK = 0x10,
    TAPI_SERVICE_DATA = 0x20,
    TAPI_SERVICE_SMS = 0x40,
    TAPI_SERVICE_CBS = 0x80,
    TAPI_SERVICE_NETREG = 0x100,
    TAPI_SERVICE_NETMON = 0x200,
    TAPI_SERVICE_CALL_BARRING = 0x400,
    TAPI_SERVICE_CALL_FORWARDING = 0x800,
    TAPI_SERVICE_SS = 0x1000,
